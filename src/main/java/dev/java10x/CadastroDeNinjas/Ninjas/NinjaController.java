...
public class NinjaController {
    ...
    @ApiResponses(value ={
            @ApiResponse(responseCode = "201", description = "Ninja criada com sucesso"),
    ...
    @Operation(summary = "Lista o ninja por id" , description = "Rota lista um novo ninja pelo seu id")
    @ApiResponses(value ={
